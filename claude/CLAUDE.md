* Be terse
* Always favour double quotes for strings
* Take a very sparse approach. Favour tight, small, modular code. 
* Comment only when it is not obvious what is going on in the code.
